...
-(id)init
{
    self = [self initWithFrame:CGRectMake(0, 95, 250, 250)];
    if (self)
    {
...
- (void)drawRect:(CGRect)rect
{
    ...
    UIButton * buttonPrev          = [[UIButton alloc] initWithFrame:CGRectMake(_originX, 42, _dayWidth-15, _dayWidth-15)];
    //[buttonPrev setTitle:@"<" forState:UIControlStateNormal];
    [buttonPrev setBackgroundImage:[UIImage imageNamed:@"left_arrow_calender.png"] forState:UIControlStateNormal];
    ...
    UIButton * buttonNext          = [[UIButton alloc] initWithFrame:CGRectMake(self.bounds.size.width - _dayWidth - _originX, 42, _dayWidth-15, _dayWidth-15)];
//    [buttonNext setTitle:@">" forState:UIControlStateNormal];
    [buttonNext setBackgroundImage:[UIImage imageNamed:@"right_arrow_calender.png"] forState:UIControlStateNormal];
    ...
    if (!_hideMonthLabel)
    {
        UILabel *titleText              = [[UILabel alloc]initWithFrame:CGRectMake(0,35, self.bounds.size.width, _originY)];
        titleText.textAlignment         = NSTextAlignmentCenter;
        titleText.text                  = dateString;
        //titleText.font                  = _titleFont;
        titleText.font                  = [UIFont fontWithName:@"Apple SD Gothic Neo" size:15.0f];
        titleText.textColor             = [UIColor darkGrayColor];//_monthAndDayTextColor;
